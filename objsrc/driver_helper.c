...
/* Compile hash: 2fz2vBMrpHBn9UhmWzL7jiVFjjx9 */
/* ------------------------------ DIRECTIVES -------------------------------- */
...
typedef nlmulret_nlboolean_nlpointer_nelua_GCItem_ptr (*function_5paoSBsFiJnrUqwP7)(nelua_hashmap_iteratorT_ptr, void*);
...
typedef struct nlmulret_function_5paoSBsFiJnrUqwP7_nelua_hashmap_iteratorT_nlpointer {
  function_5paoSBsFiJnrUqwP7 r1;
  nelua_hashmap_iteratorT r2;
  void* r3;
} nlmulret_function_5paoSBsFiJnrUqwP7_nelua_hashmap_iteratorT_nlpointer;
static NELUA_INLINE nlmulret_function_5paoSBsFiJnrUqwP7_nelua_hashmap_iteratorT_nlpointer nelua_mpairs_1(nelua_hashmap_pointer__GCItem__ptr a);
...
static NELUA_INLINE nlmulret_function_5paoSBsFiJnrUqwP7_nelua_hashmap_iteratorT_nlpointer nelua_hashmap_pointer__GCItem____mpairs(nelua_hashmap_pointer__GCItem__ptr self);
...
typedef void (*function_GkW6Mupw1ypj9ZXG)(nelua_GC_ptr);
...
typedef void (*function_9rnRKnn5Z1Dvz8ss)(void*, void*);
static void nelua_GC_maybecollect(nelua_GC_ptr self);
static void nelua_GC_register(nelua_GC_ptr self, void* ptr, uintptr_t size, uintptr_t flags, function_9rnRKnn5Z1Dvz8ss finalizer, void* userdata);
...
typedef int (*function_4dtuWfXL2XRZHKgZJ)(int, nlcstring_ptr);
...
typedef int (*function_51hJiiKyHqng9j78z)(FILE_ptr);
struct nelua_FStream {
  FILE_ptr fp;
  function_51hJiiKyHqng9j78z closef;
};
...
static NELUA_INLINE int nelua_tolower(int c);
...
typedef int (*function_43UVNnrhgqFQuHj1B)(FILE_ptr);
static nelua_filestream nelua_filestream__fromfp(FILE_ptr fp, function_43UVNnrhgqFQuHj1B closef);
...
/* ------------------------------ DEFINITIONS ------------------------------- */
nlmulret_function_5paoSBsFiJnrUqwP7_nelua_hashmap_iteratorT_nlpointer nelua_mpairs_1(nelua_hashmap_pointer__GCItem__ptr a) {
  nlmulret_function_5paoSBsFiJnrUqwP7_nelua_hashmap_iteratorT_nlpointer _ret_1 = nelua_hashmap_pointer__GCItem____mpairs(a);
  return (nlmulret_function_5paoSBsFiJnrUqwP7_nelua_hashmap_iteratorT_nlpointer){_ret_1.r1, _ret_1.r2, _ret_1.r3};
}
...
nlmulret_function_5paoSBsFiJnrUqwP7_nelua_hashmap_iteratorT_nlpointer nelua_hashmap_pointer__GCItem____mpairs(nelua_hashmap_pointer__GCItem__ptr self) {
  return (nlmulret_function_5paoSBsFiJnrUqwP7_nelua_hashmap_iteratorT_nlpointer){nelua_hashmap_iteratorT_mnext, (nelua_hashmap_iteratorT){.container = self, .index = 0xffffffffffffffffULL}, NULL};
}
...
void nelua_GC_unmarkall(nelua_GC_ptr self) {
  {
    nlmulret_function_5paoSBsFiJnrUqwP7_nelua_hashmap_iteratorT_nlpointer _asgnret_1 = nelua_mpairs_1((&self->items));
    function_5paoSBsFiJnrUqwP7 __fornext = _asgnret_1.r1;
...
void nelua_GC_markstack(nelua_GC_ptr self) {
  jmp_buf regs = {0};
  setjmp(regs);
  volatile function_GkW6Mupw1ypj9ZXG markstackinner = nelua_GC_markstackinner;
  markstackinner(self);
}
...
void nelua_GC_registerroots(nelua_GC_ptr self) {
  nelua_GC_register((&nelua_gc), (void*)(&nelua_io_stderr), 8U, 2U, (function_9rnRKnn5Z1Dvz8ss)NULL, (void*)NULL);
  nelua_GC_register((&nelua_gc), (void*)(&nelua_io_stdout), 8U, 2U, (function_9rnRKnn5Z1Dvz8ss)NULL, (void*)NULL);
  nelua_GC_register((&nelua_gc), (void*)(&nelua_io_stdin), 8U, 2U, (function_9rnRKnn5Z1Dvz8ss)NULL, (void*)NULL);
  nelua_GC_register((&nelua_gc), (void*)(&nelua_arg), 8U, 2U, (function_9rnRKnn5Z1Dvz8ss)NULL, (void*)NULL);
  nelua_GC_register((&nelua_gc), (void*)(&nelua_stderrfs), 16U, 2U, (function_9rnRKnn5Z1Dvz8ss)NULL, (void*)NULL);
  nelua_GC_register((&nelua_gc), (void*)(&nelua_stdoutfs), 16U, 2U, (function_9rnRKnn5Z1Dvz8ss)NULL, (void*)NULL);
  nelua_GC_register((&nelua_gc), (void*)(&nelua_stdinfs), 16U, 2U, (function_9rnRKnn5Z1Dvz8ss)NULL, (void*)NULL);
}
...
void nelua_GC_register(nelua_GC_ptr self, void* ptr, uintptr_t size, uintptr_t flags, function_9rnRKnn5Z1Dvz8ss finalizer, void* userdata) {
  if(NELUA_UNLIKELY((!(ptr != NULL)))) {
    return;
  }
  if((size < 8)) {
...
int main(int argc, nlcstring_ptr argv) {
  ...
  volatile function_4dtuWfXL2XRZHKgZJ inner_main = nelua_main;
...
int nelua_tolower(int c) {
  return ((((unsigned int)c - 65U) < 26) ? (c | 32) : c);
}
nlstring nelua_nlstring_lower(nlstring s) {
  ...
  for(uintptr_t i = 0U, _end = s.size; i < _end; i = i + 1) {
    ret.data[i] = (uint8_t)nelua_tolower((int)s.data[i]);
  }
  return ret;
}
...
nelua_filestream nelua_filestream__fromfp(FILE_ptr fp, function_43UVNnrhgqFQuHj1B closef) {
...
nlmulret_nlboolean_nlstring_nlint64 nelua_filestream_close(nelua_filestream_ptr self) {
  ...
  self->fs->closef = (function_51hJiiKyHqng9j78z)NULL;
