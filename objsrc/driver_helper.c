...
/* Compile hash: 2i4wJSa2paUGXJ1ndbpB6xqWm3UW */
/* ------------------------------ DIRECTIVES -------------------------------- */
...
nlstring driver_helper_make_header(nelua_vector_line_content_ csv) {
  ...
  nelua_stringbuilderT_write_1((&builder), ((nlstring){(uint8_t*)nelua_strlit_2, 1107}));
